...
export default function KeywordsPageClient({ keywords }: Props) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <HorizonCard delay={0.1} className="p-5 mb-3">
        <p className="text-xs font-body mb-1" style={{ color: 'var(--text-muted)' }}>
          Interest over time (demo)
        </p>
        ...
        {keywords.map((kw, i) => (
          ...
          >
            ...
            >
              ...
              <span className="font-body text-sm font-semibold flex-1 truncate" style={{ color: 'var(--text-star)' }}>
                {kw.keyword}
              </span>

              <span className="font-data text-sm tabular-nums shrink-0" style={{ color: 'var(--text-muted)' }}>
                {kw.score}
              </span>
